  ...
  <div class="menu-lateral">
    <div class="item-lista">
      <ul>
        ...
        <li id="principal">Acessibilidade</li>
    ...
    <div class="icon-lista">
      ...
      <a href="https://github.com" target="_blank" aria-label="GitHub">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#626262" viewBox="0 0 24 24">
          <path
            d="M12 0C5.371 0 0 5.373 0 12c0 5.303 3.438 9.8 8.207 11.387.6.111.793-.26.793-.577
            0-.285-.01-1.04-.016-2.04-3.338.726-4.042-1.612-4.042-1.612-.546-1.387-1.333-1.756-1.333-1.756
            -1.09-.744.083-.729.083-.729 1.205.086 1.838 1.236 1.838 1.236 1.07 1.834 2.809 1.304
            3.495.997.108-.775.419-1.305.762-1.604-2.665-.303-5.466-1.335-5.466-5.932
            0-1.31.469-2.381 1.236-3.221-.124-.303-.536-1.524.117-3.176
            0 0 1.008-.322 3.3 1.23a11.53 11.53 0 013.006-.404c1.02.005 2.045.138 3.006.404
            2.29-1.553 3.297-1.23 3.297-1.23.655 1.653.243 2.874.119 3.176.77.84
            1.235 1.911 1.235 3.221 0 4.61-2.804 5.625-5.475 5.921.43.372.823 1.102.823
            2.222 0 1.604-.014 2.896-.014 3.293 0 .319.192.694.801.576C20.565
  ...
  <div class="tudo">
    <div class="conteudo">
      <main class="content">
        ...
        <section class="card-acessibilidade fade-in">
  <h2>Personalize sua experiência</h2>
  <p>Escolha as opções abaixo para tornar o site mais confortável para você.
    As preferências serão salvas automaticamente.</p>

  <div class="acoes-acessibilidade">
    <div class="grupo">
  <h3><i class="fa-solid fa-circle-half-stroke"></i> Tema</h3>
  <button id="toggle-dark-mode-card">
    <i class="fas fa-moon" id="theme-icon-card"></i>
    Alternar Tema
  </button>
</div>
    ...
    <div class="grupo">
      <h3><i class="fa-solid fa-arrows-left-right-to-line"></i> Espaçamento das Letras</h3>
      <button onclick="acessibilidade.alterarEspacamento('aumentar')">+</button>
      <button onclick="acessibilidade.alterarEspacamento('diminuir')">-</button>
      <button onclick="acessibilidade.resetar()">Resetar</button>
    </div>
  </div>
</section>
