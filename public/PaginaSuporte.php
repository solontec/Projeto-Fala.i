...
<body>
  ...
  <div class="tudo">
    <div class="conteudo">
      ...
      <div class="problema">
        <p>No espaço abaixo relate o problema que está enfrentando ao usar nossa plataforma para que possamos ajudar através do nosso suporte</p>
        <textarea name="" id=""></textarea>
        <button type="submit">Enviar</button>
        <p>Após relatar o problema, espere a resposta na sua caixa de e-mail.</p>
      </div>
    </div>
  </div>
