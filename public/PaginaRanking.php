...
<body>
    ...
    <nav>
        ...
        <div class="nav-right">
            <button id="toggle-dark-mode" class="toggle-mode">
        ...
        <div class="tudo">
            ...
            <div class="esquerda">
                ...
                <?php if (isset($top3[1])): ?>
                    <div class="segundo colocacao">
                        <div class="prata">
                            <img src="assets/img/prata.png" width="150">
                        </div>
                        <div class="altura altura-segundo">
                            <strong class="altura texto-prata"><?= $top3[1]['nome'] ?></strong>
                            <strong class="altura texto-prata"><?= $top3[1]['pontos'] ?> pontos</strong>
                ...
                <?php if (isset($top3[0])): ?>
                    <div class="primeiro colocacao">
                        <div class="ouro">
                            <img src="assets/img/ouro.png" width="180">
                        </div>
                        <div class="altura altura-primeiro">
                            <strong class="altura texto-ouro"><?= $top3[0]['nome'] ?></strong>
                            <strong class="altura texto-ouro"><?= $top3[0]['pontos'] ?> pontos</strong>
                ...
                <?php if (isset($top3[2])): ?>
                    <div class="terceiro colocacao">
                        <div class="bronze">
                            <img src="assets/img/bronze.png" width="140">
                        </div>
                        <div class="altura altura-terceiro">
                            <strong class="altura texto-bronze"><?= $top3[2]['nome'] ?></strong>
                            <strong class="altura texto-bronze"><?= $top3[2]['pontos'] ?> pontos</strong>
                        </div>
                    </div>
                <?php endif; ?>
            ...
            <div class="esquerda2">
                ...
                <div class="texto-ranking">
                    ...
                    <p id="letra" style="text-indent: 1em;">
                        Aqui é onde a oratória deixa de ser teoria e vira competição de verdade!
                        Descubra seus rivais e prove que sua voz merece ser ouvida!
                    </p>
                </div>
                ...
                <div class="direita">
                    ...
                    <?php foreach ($restantes as $i => $usuario): ?>
                        <div class="posicao">
    ...
    <script src="static/PaginaRanking/PaginaRanking.js"></script>
</body>
