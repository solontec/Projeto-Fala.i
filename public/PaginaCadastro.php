...
<head>
    ...
    <link rel="stylesheet" href="{{ url_for('static', filename='PaginaCadastro/PaginaCadastro.css') }}">
...
<body>
        ...
        <div class="tudo">
            ...
            <div class="direita">
                <div class="container-cadastro" id="container-cadastro">
                    <div class="cadastro">
                        <h3>Cadastro</h3>
                        <form method="POST" action="../src/Controller/CadastroController.php" id="form-cadastro">
                            ...
                            <div class="cadastro-entrar">
                                <div class="botoes-linha">
                                    ...
                                    <p id="ou">ou</p>
                                    <a type="button" id="entrar2" href="/">Entrar</a>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <script src="{{ url_for('static', filename='PaginaCadastro/PaginaCadastro.js') }}"></script>
</body>
